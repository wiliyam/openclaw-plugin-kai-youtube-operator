...
import type { AudioMixMode, CommandResult, GeneratedAudioStyle, JsonObject, ShortAspect, ShortFit } from "./types.js";
...
export function defaultShortOutputPath(inputPath: string): string {
